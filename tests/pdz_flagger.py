...
def parse_args():
    ...
    parser.add_argument(
        "--cat_flagged", default="cat_flagged.out", help="Output catalog path (cat_flagged.out)"
    )

    parser.add_argument(
        "--max_rows", type=int, default=None, help="Maximum number of PDZ rows to process (None)"
    )
