...
def test_offsets(test_data_dir: str):
    ...
    # Check that adding a SYSSHIFT breaks the assertions
    config["APPLY_SYSSHIFT"] = lp.keyword("APPLY_SYSSHIFT", ",".join([str(o) for o in np.linspace(0, 1, 2)]))
