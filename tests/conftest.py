...
@pytest.fixture
def set_env_vars():
    os.environ["LEPHAREDIR"] = os.path.join(os.path.abspath(os.path.dirname(__file__)), "data")
    os.environ["LEPHAREWORK"] = os.path.join(os.path.abspath(os.path.dirname(__file__)), "tmp")
