...
#pragma omp parallel
 ...
 // since clock() returns the sum of all threads, we need to use the openmp timer to measure the time
#ifdef _OPENMP
  ...
  */
  ...
  string list_keywords[] =  {"t","COSMOLOGY","FILTER_FILE","MAGTYPE","EXTINC_LAW","EB_V","MOD_EXTINC","ZGRID_TYPE","Z_STEP","GAL_LIB_IN","QSO_LIB_IN","STAR_LIB_IN","GAL_LIB_OUT","QSO_LIB_OUT","STAR_LIB_OUT","LIB_ASCII","EM_LINES","EM_DISPERSION","ADD_DUSTEM","VERBOSE"};
  //Number of keywords
  ...
  // Define a pointer of the basis class "Mag" which encompasses all the elements to create the library
  Mag *Magnitude;
