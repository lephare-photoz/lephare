...
/*! \brief Class Extinction to store the lambda/value vector from the extinction law read
 *
 * The Mag class is in charge of creating and filling the ext instances for each extinction laws
 * to be read from files provided in the config.
 */
class ext
{
 public:
